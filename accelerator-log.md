...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=vrabbi&repo=tap-acc-v2-demo",
  "owner" : "platform-team",
  "system" : "demo-apps"
}
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tap-acc-v2-demo]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=tap-acc-v2-demo'
